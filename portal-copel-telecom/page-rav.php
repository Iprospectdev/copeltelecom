				...
				<div class="row">
					...
					<article class="col-sm-9 col-xs-12">
						...
						<div role="tabpanel" class="tab-pane" id="sua-instalacao">
							<form action="?step=sua-instalacao" id="form-sua-instalacao" method="post" class="form-rav">
								<fieldset>
									<div class="row">
								...
								<fieldset>
									...
									<div class="row">
										<label class="col-sm-10">
											<div class="dropdown dropdown-select">
												<input type="text" name="plano-text" value="1 Mbps" readonly>
												<input type="hidden" name="plano" value="1 Mbps">
												<button type="button" data-toggle="dropdown"><i class="fa fa-angle-down"></i></button>
												<ul class="dropdown-menu">
								...
								<div class="text-center"><button class="bt-o add-field-rav" type="button">Adicionar outro endereço de instalação</button></div>
								<button class="bt-o-b active">SEGUINTE</button>
							</form>
						</div>
