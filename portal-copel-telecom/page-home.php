...
?>
    <section class="page-home">   
        ...
        <section class="home-bandalarga" id="bandalarga">
            ...
            <div class="d-none d-lg-block home-bandalarga--bg-destaque"><img src="<?php bloginfo('template_url'); ?>/_assets/images/sobre-nos-banner.jpg" alt=""></div>
            <div class="container">
                <div class="row">
                    <div class="col-lg-5">
                    ...
                    <div class="d-none d-md-block col-md-7 mapa">
                    ...
                    <div class="col-md-6 col-lg-3 destaque">
                        <h6>App Copel</h6>
