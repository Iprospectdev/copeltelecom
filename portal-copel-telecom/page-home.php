            ...
            ?>
                    <div class="home-carousel--item">
                        <?php if(get_sub_field('image')): ?>
                            <img src="<?php echo get_sub_field('image'); ?>" class="d-none d-md-block" alt="">
                        <?php endif; ?>
                        <?php if(get_sub_field('image_mobile')): ?>
                            <img src="<?php echo get_sub_field('image_mobile'); ?>" class="d-block d-md-none" alt="">
                        <?php endif; ?>
                        <div class="container">
                            <h6>
                                <?php if(get_sub_field('icon')): ?>
                                    <img src="<?php the_sub_field('icon'); ?>" alt="Icone Game Over">
                                <?php endif; ?>
                                <?php echo get_sub_field('text'); ?>
                            </h6>
                            <?php echo (get_sub_field('heading')) ? '<h5>'.get_sub_field('heading').'</h5>' : ''; ?>
    		...
    		<section class="home-ei home-usos--height" id="ei">
                <div class="container d-flex align-items-center">
                    <div class="home-usos--content">
                        ...
                        <p>A Copel Fibra entrega a internet que você precisa, na hora que você precisa, para tudo o que você precisa.</p>
                        <a href="<?php bloginfo('url') ?>/parcerias/esporte-interativo" class="btn-more">Saiba mais</a>
                    </div>
                </div>
    		</section>
    		<section class="home-cn-ja home-usos--height" id="cnja">
                <div class="container d-flex align-items-center">
                    <div class="home-usos--content">
                        ...
                        <p>A Copel Fibra entrega a internet que você precisa, na hora que você precisa, para tudo o que você precisa.</p>
                        <a href="<?php bloginfo('url') ?>/parcerias/cartoon-network" class="btn-more">Saiba mais</a>
                    </div>
                </div>
    		</section>
        </div>
