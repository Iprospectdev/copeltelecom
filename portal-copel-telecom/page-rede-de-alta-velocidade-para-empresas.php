			...
			<div class="container">
				<div class="breadcrumb">
					<ul>
						...
						<li><span>Mpls VPN Rede de Alta Velocidade para Empresas e Setor Público</span></li>
					</ul>
				</div>
				<h1>Mpls VPN Rede de Alta Velocidade<br>para Empresas e Setor Público</h1>
				<h2>Rede que interliga dois ou mais pontos dentro do Estado.</h2>
			</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-4">
						...
						<p>
							O Mpls VPN Rede de Alta Velocidade para Empresas e Setor Público é uma interligação de redes locais privadas corporativas, isoladas da Internet, feita através de portas ethernet e roteamento sob plataforma IP/MPLS.<br>
							<a href="<?php bloginfo('template_url'); ?>/_assets/pdf/rav.v.20130520.pdf" target="_blank">Confira as características do serviço</a>
						</p>
					</div>
					<div class="col-sm-8"><img src="<?php bloginfo('template_url'); ?>/_assets/old/images/empresas/mpls-alta-velocidade.png" alt=""></div>
				</div>
			</div>
		</article>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-sm-12 col-xs-12">
						...
						<p>
							O Mpls VPN Rede de Alta Velocidade para Empresas e Setor Público tem cobertura em todo o Paraná.
						</p>
						<p>
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-6 col-sm-offset-3 col-xs-12">
						...
						<p>Preencher o <a href="<?php $p = get_page_by_title("Rav"); echo get_permalink($p->ID); ?>">formulário de pedido de viabilidade</a>.</p>
					</div>
				</div>
			</div>
		</article>
				...
				<div class="row">
					...
					<div class="col-sm-9 col-xs-12">
						<ul class="row">
							...
							<li class="col-xs-12 col-sm-4" data-mh="pa-group">
								<i class="i-ep-grafico"></i>
								<p><strong>QOS</strong><br>Serviço de priorização de tráfego sob a plataforma VPN IP/MPLS e rede estatística.</p>
							</li>
							<li class="col-xs-12 col-sm-4" data-mh="pa-group">
								<i class="i-ep-grafico"></i>
								<p><strong>Multicast</strong><br>Serviço para transmissões de vídeo por meio de portas ethernet, roteamento sob plataforma VPN IP/MPLS, rede estatística e modo multicast.</p>
							</li>
							<li class="col-xs-12 col-sm-4" data-mh="pa-group">
								<i class="i-ep-grafico"></i>
								<p><strong>Firewall</strong><br>Barreira de proteção para análise de pacotes de dados trafegados e controle de acesso às VPNs.</p>
							</li>
							<li class="col-xs-12 col-sm-4" data-mh="pa-group">
								<i class="i-ep-grafico"></i>
								<p><strong>Redundância</strong><br>Produto de redundância física com segunda fibra conectada ao EDD (Ethernet Demarcation Device) e que entra em operação automaticamente caso o link principal caia.</p>
							</li>
						</ul>
					</div>
				</div>
