			...
			<div class="container">
				<div class="breadcrumb">
					<ul>
						...
						<li><span>Conexão Ethernet ponto a ponto para Operadoras e Provedores</span></li>
					</ul>
				</div>
				<h1>
					Conexão Ethernet ponto a ponto<br>para Operadoras e Provedores
				</h1>
				<h2>Interconexão ponto a ponto de duas redes locais dentro do Paraná.</h2>
			</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-4">
						...
						<p>
							A Conexão Ethernet ponto a ponto para Operadoras e Provedores realiza a conexão ponto a ponto de duas redes locais Ethernet dentro do estado do Paraná.<br>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-sm-12 col-xs-12">
						...
						<p>
							A Conexão Ethernet ponto a ponto para Operadoras e Provedores tem cobertura em todo o Paraná.
						</p>
						<p>
