...
?>
	<section id="page-esporte-interativo">
		...
		<div class="esporte-interativo-content">
			<div class="container">
				...
				<div class="container">
					...
					<article class="row">
						...
						<div class="col-sm-4">
							...
							<p>No aplicativo Esporte Interativo Plus você pode acompanhar todos os conteúdos dos Canais Esporte Interativo no celular, no computador, na smart TV LG, no tablet ou na Apple TV.</p>

							<a href="#como-acessar" class="bt bt-orange">SAIBA COMO ACESSAR</a>
						</div>

						<figure class="col-sm-8 text-center">
			...
			<div class="container" id="como-acessar">
				...
				<article>
					...
					<div class="text-center">
						...
						<div class="col-sm-10 col-sm-offset-1 text-center">
							...
							<p>
								Confira abaixo como é fácil baixar o aplicativo do <strong class="text-orange">Esporte Interativo Plus</strong> na seu smartphone ou tablet:<br>
								*O plano do <strong class="text-orange">Esporte Interativo Plus</strong> permite até dois acessos simultâneos.
							</p>
					...
					<ul class="row">
						<li class="col-sm-3 col-xs-6 mrg30B">
							<div data-mh="group-li">
								<i>1</i>
								<span>Os seus dados de acesso (login e senha) foram enviados para o seu e-mail cadastrado na Copel Telecom*</span>
								<span class="space-25"></span>
								<img src="<?php bloginfo('template_url'); ?>/_assets/images/esporte-interativo/i-email.png" alt="Email">
							</div>
						</li>
						<li class="col-sm-3 col-xs-6 mrg30B">
							<div data-mh="group-li">
								<i>2</i>
								<span>Acesse a loja de aplicativos no seu Smartphone ou tablet e baixe o aplicativo <strong>Esporte Interativo Plus</strong></span>
						...
						<li class="col-sm-3 col-xs-6 mrg30B">
							<div data-mh="group-li">
								<i>3</i>
								<span>No aplicativo <strong>Esporte Interativo Plus</strong>, faça o login com o dados de acesso recebidos por e-mail*</span>
			...
			<article class="esporte-interativo-footer">
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-sm-7">
							...
							<p>
								O acesso gratuito ao aplicativo Esporte Interativo Plus está disponível para clientes de planos residenciais a partir de 30 Mbps
							</p>
						</div>
		...
		<div class="esporte-interativo-planos">
