...
<head>
	...
	<link href="<?php bloginfo('template_url');?>/_assets/old/css/all.min.css" rel="stylesheet">
		...
		<div class="container">
					...
					<nav class="nav-out">
						...
						<div class="nav-acessibilidade">
							<a href="<?php $p = get_page_by_title("Acessibilidade"); echo get_permalink($p->ID); ?>" title="Acessibilidade">
								<img src="<?php bloginfo("template_url"); ?>/_assets/old/images/libras.png" alt=""> Acessibilidade
							</a>
			...
			<div class="nav-site menu_navegacao">
				...
				<a href="<?php bloginfo("url"); ?>/" class="logo-copel">
					<img src="<?php bloginfo("template_url"); ?>/_assets/old/images/logo-copel-header.png" alt="<?php bloginfo("name"); ?>" />
				</a>
