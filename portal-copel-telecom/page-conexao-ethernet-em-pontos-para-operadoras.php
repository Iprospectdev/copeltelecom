	...
	<section class="empresas home-empresas-intena">
			...
			<div class="container">
				<div class="breadcrumb">
					<ul>
						...
						<li><span>Conexão Ethernet em Pontos de Troca de Tráfego para Operadoras e Provedores</span></li>
					</ul>
				</div>
				<h1>
					Conexão Ethernet em Pontos de<br>Troca de Tráfego para Operadoras e Provedores
				</h1>
				<h2>A Conexão Ethernet em Pontos de Troca de Tráfego para Operadoras e Provedores fornece troca de tráfego de internet por meio da infraestrutura de rede da Copel Telecom.</h2>
			</div>
		...
		<article id="vantagens" class="home-empresas-intena-vantagens">
			<div class="container">
				<div class="row">
					<div class="col-sm-3">
						<h4 class="main-tt-barra">Vantagens</h4>
					</div>
					<div class="col-sm-9">
						<ul class="row">
							...
							<li class="col-sm-4" data-mh="vantagens">
								<i class="i-ev-fibra"></i>
								<p>Maior controle da rede em relação à entrega de tráfego.</p>
							</li>
							<li class="col-sm-4" data-mh="vantagens">
								<i class="i-ev-fibra"></i>
								<p>Conexão direta de alta qualidade, independente de provedores comerciais.</p>
							</li>
							<li class="col-sm-4" data-mh="vantagens">
								<i class="i-ev-fibra"></i>
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-4">
						...
						<p>
							A Conexão Ethernet em Pontos de Troca de Tráfego para Operadoras e Provedores conecta o cliente aos Pontos de Troca de Tráfego (PTT) dentro do Paraná.<br>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-sm-12 col-xs-12">
						...
						<p>
							A Conexão Ethernet em Pontos de Troca de Tráfego para Operadoras e Provedores tem cobertura em todo o Paraná.
						</p>
						<p>
