	...
	<section id="home-empresas-operadoras-e-provedores" class="empresas">
		<div class="container">
			<header class="main-tt-highlight">
				<h1>
					Cidadãos interagindo todos os dias com a qualidade <br>
					e a inovação.
				</h1>
				<h2>
					<strong>Melhoria da gestão pública na velocidade da luz</strong><br>
					Com as soluções da Copel Telecom, é possível integrar secretarias e departamentos <br>
					de órgãos públicos, além de viabilizar e agilizar a implantação da cidade digital. 
				</h2>
			</header>
		</div>

		<nav class="empresas-nav">
			<a href="#solucoes-de-banda-larga" class="bt-o">Soluções de Banda Larga</a>
		...
		<article id="solucoes-de-banda-larga">
			<header class="container">
				<div class="empresas-aside">
					<h3>Soluções de Banda Larga<br>Internet de alta velocidade e disponibilidade com tecnologia 100% em fibra óptica.</h3></div>
			</header>
					...
					<ul class="row">
						...
						<li class="nav-highlights-blue-light col-sm-6 col-xs-12">
							<div class="nav-highlights-tt no-icon" data-mh="nav-highlight-group">
								...
								<p>Serviço de internet por fibra óptica com endereço IP fixo. Só os seus negócios é que não vão parar. </p>
		...
		<article id="solucoes-de-redes">
			<header class="container">
				<div class="empresas-aside">
					<h3>Soluções de Redes<br>Soluções de rede da Copel Telecom: interligação direta com serviços de qualidade.</h3></div>
			</header>
			<div class="nav-highlights empresas-produtos-highlight wow fadeIn">
				<div class="container">
					<ul class="row">
						<li class="nav-highlights-blue col-sm-6 col-xs-12">
							<div class="nav-highlights-tt no-icon" data-mh="nav-highlight-group">
								<h4>
									Mpls VPN Rede de Alta Velocidade para Empresas e Setor Público
								</h4>
						...
						<li class="nav-highlights-blue col-sm-6 col-xs-12">
							<div class="nav-highlights-tt no-icon" data-mh="nav-highlight-group">
								<h4>
									Conexão Ethernet ponto a ponto para Empresas e Setor Público
								</h4>
		...
		<article id="solucoes-de-canal-dedicado">
			<header class="container">
				<div class="empresas-aside">
					<h3>Solução de Canal Dedicado<br>Solução perfeita para gestores que se dedicam a oferecer serviços públicos de qualidade.</h3></div>
			</header>
			<div class="nav-highlights empresas-produtos-highlight wow fadeIn">
				<div class="container">
					<ul class="row">
						<li class="nav-highlights-blue-light col-xs-12">
							<div class="nav-highlights-tt no-icon" data-mh="nav-highlight-group">
								<h4>
